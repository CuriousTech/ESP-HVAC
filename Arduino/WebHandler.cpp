...
//  Serial.println("handleRoot");
  ...
  String page = 
   ...
   "    <td colspan=\"2\" style=\"width: 190px\" class=\"style1\">\n"
   ...
   "    <input type=\"button\" value=\"Fan\" name=\"hmFan\" onClick=\"{setHumidMode(1)}\">\n"
   "    <input type=\"button\" value=\"Run\" name=\"hmRun\" onClick=\"{setHumidMode(2)}\">\n"
   "    <input type=\"button\" value=\"A1\" name=\"hmAuto1\" onClick=\"{setHumidMode(3)}\">\n"
   "    <input type=\"button\" value=\"A2\" name=\"hmAuto2\" onClick=\"{setHumidMode(4)}\">\n"
   "    </td>\n"
   "  </tr>\n"
   "  <tr>\n"
   "    <td>Cool Hi</td>\n"
