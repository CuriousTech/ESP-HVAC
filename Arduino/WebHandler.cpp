...
//  Serial.println("---handleRoot");
  ...
  const String page = 
   ...
   "<input type=\"button\" value=\"Auto\" name=\"fAuto\" onClick=\"{setfan(0)}\"><input type=\"button\" value=\" On \" name=\"fOn\" onClick=\"{setfan(1)}\"><input type=\"button\" value=\"Cy\" name=\"fS\" onClick=\"{setfan(2)}\"></td>\n"
   "</tr>\n"
   "<tr>\n"
   "<td>Heat Hi</td>\n"
   ...
   "<td>\n"
   "<input id=\"myToken\" name=\"access_token\" type=text size=50 placeholder=\"e6bba7456a7c9\" style=\"width: 265px\"></td>\n"
   "</tr>\n"
   "</table></p>\n"
