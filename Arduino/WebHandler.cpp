...
//  Serial.println("handleRoot");
 ...
 String page = 
   ...
   "    document.all.hm.innerHTML = rh?\"Humid On\":\"Humid Off\"\n"
   "    setAtt()\n"
   "  },false)\n"
   "  eventSource.addEventListener('alert',function(e){ // listen to alerts\n"
   "    alert(e.data)\n"
   "  },false)\n"
   "}\n"
   "\n"
   ...
   "    document.all.humidl.value= +Json.rh0/10\n"
   "    document.all.humidh.value= +Json.rh1/10\n"
   ...
   "  document.all.hmCell.setAttribute('class',rh?'style5':'style1')\n"
   ...
   "\n"
   "  document.all.hmOff.setAttribute('class',humidMode==0?'style5':'')\n"
   "  document.all.hmHeat.setAttribute('class',humidMode==1?'style5':'')\n"
   "  document.all.hmCool.setAttribute('class',humidMode==2?'style5':'')\n"
   "  document.all.hmBoth.setAttribute('class',humidMode==3?'style5':'')\n"
   "  document.all.hmAuto1.setAttribute('class',humidMode==4?'style5':'')\n"
   "  document.all.hmAuto2.setAttribute('class',humidMode==5?'style5':'')\n"
   "  document.all.hmManual.setAttribute('class',humidMode==6?'style5':'')\n"
   "}\n"
   "\n"
   "function setCoolHi()\n"
   "{\n"
   ...
   "function setHumidHi()\n"
   "{\n"
   "  setVar('humidh',(+document.all.humidh.value*10).toFixed())\n"
   "}\n"
   "\n"
   "function setHumidLo()\n"
   "{\n"
   "  setVar('humidl',(+document.all.humidl.value*10).toFixed())\n"
   "}\n"
   "\n"
   "function incHumid(n)\n"
   "{\n"
   "  document.all.humidh.value= +document.all.humidh.value+n\n"
   "  document.all.humidl.value= +document.all.humidl.value+n\n"
   "\n"
   "  setVar('humidh',(+document.all.humidh.value*10).toFixed())\n"
   "  setVar('humidl',(+document.all.humidl.value*10).toFixed())\n"
   "}\n"
   ...
   "  </tr>\n"
   "  <tr>\n"
   "    <td style=\"width: 44px\" class=\"style1\" id=\"hmCell\"><div id=\"hm\">NA</div></td>\n"
   "    <td colspan=\"2\">\n"
   ...
   "  </tr>\n"
   "  <tr>\n"
   "    <td style=\"width: 81px\" class=\"style1\">Humid Hi</td>\n"
   "    <td style=\"width: 44px\" class=\"style1\"><input type=text size=5 value=0 id=\"humidh\"></td>\n"
   "    <td style=\"width: 200px\" class=\"style1\"><input type=\"button\" value=\"Set\" onClick=\"{setHumidHi()}\"><input type=\"button\" value=\"+1\" onClick=\"{incHumid(1)}\"></td>\n"
   "  </tr>\n"
   "  <tr>\n"
   "    <td style=\"width: 81px\" class=\"style1\">Humid Lo</td>\n"
   "    <td style=\"width: 44px\" class=\"style1\"><input type=text size=5 value=0 id=\"humidl\"></td>\n"
   "    <td style=\"width: 200px\" class=\"style1\"><input type=\"button\" value=\"Set\" onClick=\"{setHumidLo()}\"><input type=\"button\" value=\" -1\" onClick=\"{incHumid(-1)}\"></td>\n"
   "  </tr>\n"
   "  <tr>\n"
