...
const char page1[] PROGMEM = 
   ...
   "<td width=350>\n"
   "<input type=\"button\" value=\"Auto\" name=\"fAuto\" onClick=\"{setfan(0)}\"><input type=\"button\" value=\" On \" name=\"fOn\" onClick=\"{setfan(1)}\"><input type=\"button\" value=\"Cycle\" name=\"fS\" onClick=\"{setfan(2)}\"></td>\n"
   "</tr>\n"
   "<tr>\n"
   "<td></td>\n"
   "<td></td>\n"
   "<td id=\"runCell\"><div id=\"run\">N/A</div></td>\n"
   "<td>\n"
   "<input type=\"button\" value=\" Off  \" name=\"mOff\" onClick=\"{setMode(0)}\"><input type=\"button\" value=\"Cool\" name=\"mCool\" onClick=\"{setMode(1)}\"><input type=\"button\" value=\"Heat\" name=\"mHeat\" onClick=\"{setMode(2)}\"><input type=\"button\" value=\"Auto\" name=\"mAuto\" onClick=\"{setMode(3)}\"></td>\n"
   "</tr>\n"
   "<tr>\n"
   "<td>Cool Hi</td>\n"
   ...
   "<td>Password</td>\n"
   "<td>\n"
   "<input id=\"myToken\" name=\"access_token\" type=text size=40 placeholder=\"e6bba7456a7c9\" style=\"width: 190px\">\n"
   "<input type=\"submit\" value=\"Settings\" onClick=\"window.location='/settings';\">\n"
   "</td>\n"
   "</tr>\n"
   "</table></p>\n"
...
const char page2[] PROGMEM = 
   ...
   "<td>Remote Hi</td>\n"
   "<td></td>\n"
   "<td><input type=\"button\" value=\"Rmt\" name=\"rmth1\" onClick=\"{setRmt(1)}\"><input type=\"button\" value=\"Avg\" name=\"rmth2\" onClick=\"{setRmt(2)}\"><input type=\"button\" value=\"Main\" name=\"rmth3\" onClick=\"{setRmt(3)}\"></td>\n"
   "<td></td>\n"
   "</tr>\n"
   "<tr>\n"
   "<td>Remote Lo</td>\n"
   "<td></td>\n"
   "<td><input type=\"button\" value=\"Rmt\" name=\"rmtl1\" onClick=\"{setRmt(4)}\"><input type=\"button\" value=\"Avg\" name=\"rmtl2\" onClick=\"{setRmt(5)}\"><input type=\"button\" value=\"Main\" name=\"rmtl3\" onClick=\"{setRmt(6)}\"></td>\n"
   "<td></td>\n"
   "</tr>\n"
   "</table>\n"
   "<p>\n"
   ...
   "<td>Password</td>\n"
   "<td>\n"
   "<input id=\"myToken\" name=\"access_token\" type=text size=40 placeholder=\"e6bba7456a7c9\" style=\"width: 210px\">\n"
