...
const char page_chart[] PROGMEM =
   ...
   "ce=+Json.ce\n"
   "cg=+Json.cg\n"
   "div.innerHTML=(i+1)+' $'+Json.ce+' $'+Json.cg\n"
   "break\n"
   "case 'alert':\n"
   "alert(data)\n"
   "break\n"
   ...
   "tE=ce\n"
   "tG=cg\n"
   "for(i=0;i<(new Date(date.getYear(),date.getMonth()+1,0).getDate());i++)\n"
   "{\n"
   "div=document.getElementById(\"d\"+i)\n"
   "if(date.getDate()==i+1) div.setAttribute('class','style5')\n"
   "else div.innerHTML=(i+1)+' $'+Json.day[i][0].toFixed(2)+' $'+Json.day[i][1].toFixed(2)\n"
   "if(i<date.getDate())\n"
   "{\n"
   "tE+=Json.day[i][0]\n"
   "tG+=Json.day[i][1]\n"
   ...
   "div.innerHTML=mname[i]+' $'+Json.mon[i][0].toFixed(2)+' $'+Json.mon[i][1].toFixed(2)\n"
   "if(date.getMonth()==i){\n"
   "div.setAttribute('class','style5')\n"
   "div.innerHTML=mname[i]+' $'+tE.toFixed(2)+' $'+tG.toFixed(2)\n"
   "}\n"
   "}\n"
   "break\n"
   "case 'data':\n"
