const char page1[] PROGMEM = 
   ...
   "</tr>\n"
   "<tr>\n"
   "<td>ovr Time</td><td><input type=text size=3 id=\"ovrtime\"></td><td></td>\n"
   "<td>\n"
   ...
   "<td><input type=\"button\" value=\"Save\" onClick=\"{setVars()}\"></td>\n"
   "</tr>\n"
   "</table><br/>\n"
...
const char page2[] PROGMEM = 
   ...
   "<td><input type=\"button\" id =\"cost\" value=\"0\" onClick=\"{rstCost()}\"></td></tr>\n"
   ...
   "<td><input type=\"button\" value=\"Save\" onClick=\"{setVars()}\"></td></tr>\n"
   "</table>\n"
   "<p>\n"
   "<table style=\"width: 350px\">\n"
   "<tr><td>Password</td><td><input id=\"myToken\" name=\"access_token\" type=text size=40 placeholder=\"e6bba7456a7c9\" style=\"width: 150px\">\n"
...
const char chart[] PROGMEM =
   ...
   "  for(i = 0; i < data.length; i ++)\n"
   "  {\n"
   "    if(data[i][1] != 'nan' && data[i][1] < min)\n"
   "      min = data[i][1]\n"
   "    if(data[i][4] != 'nan' && data[i][4] < min)\n"
   "      min = data[i][4]\n"
   "  }\n"
