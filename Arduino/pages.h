const char page1[] PROGMEM = 
   ...
   "<td><input type=\"button\" value=\"Auto\" name=\"mAuto\" onClick=\"{setMode(3)}\">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type=\"submit\" value=\"Chart\" onClick=\"window.location='/chart.html';\">\n"
   "</td>\n"
   "</tr>\n"
   "<tr>\n"
...
const char page2[] PROGMEM = 
   ...
   " s+=',\"ppk\":'+(+a.ppkwh.value*1000).toFixed()\n"
   ...
   "<tr><td>FC Offset</td><td><input type=text size=4 id=\"fco\"></td><td>CCF</td><td><input type=text size=3 id=\"ccf\"></td></tr>\n"
   "<tr><td>Lookahead</td><td><input type=text size=4 id=\"fcr\"></td><td>Disp</td><td><input type=text size=3 id=\"fcd\"></td></tr>\n"
