...
const char page_chart[] PROGMEM =
   ...
   "div.innerHTML=(i+1)+' E $'+Json.ce+' G $'+Json.cg\n"
   "break\n"
   "case 'alert':\n"
   "alert(data)\n"
   "break\n"
   ...
   "else div.innerHTML=(i+1)+' E $'+Json.day[i][0].toFixed(2)+' G $'+Json.day[i][1].toFixed(2)\n"
   "tE+=Json.day[i][0]\n"
   "tG+=Json.day[i][1]\n"
   "}\n"
   "for(i=0;i<12;i++)\n"
   ...
   "div.innerHTML=mname[i]+' E $'+Json.mon[i][0].toFixed(2)+' G $'+Json.mon[i][1].toFixed(2)\n"
   "if(date.getMonth()==i){\n"
   "div.setAttribute('class','style5')\n"
   "div.innerHTML=mname[i]+' E $'+tE.toFixed(2)+' G $'+tG.toFixed(2)\n"
   "}\n"
   "}\n"
   "break\n"
   "case 'data':\n"
